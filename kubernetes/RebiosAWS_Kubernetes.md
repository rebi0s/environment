...
```
helm install  spark oci://registry-1.docker.io/bitnamicharts/spark -n rebios-spark -f values.yaml


kc -n rebios-spark get pods

kc -n rebios-spark get pods -o yaml

kc -n rebios-spark exec -it spark-master-0 -- bash
