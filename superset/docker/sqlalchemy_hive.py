...
class HiveDialect(default.DefaultDialect):
    ...
    def _get_table_columns(self, connection, table_name, schema):
        ...
        try:
            ...
            rows = [column for column in connection.execute('DESCRIBE {}'.format(full_table)).fetchall() if column[0] not in {"# Partitioning", "Not partitioned","# Partition Information",""}]
